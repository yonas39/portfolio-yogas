...
<!-- Adding the image with a smaller size and circular shape click to expand it-->
| Feature Description                                   | Application in OrhoNet                                  | Image |
|-------------------------------------------------------|--------------------------------------------------------|-------|
| **Microwave Timer**                                   | Used to count down in microwaves. In OrhoNet, it can be utilized in reverse to count up, indicating how long the user has been active in the app in real time. | <a href="./assignment_2_docs/microwave.png"><img src="./assignment_2_docs/microwave.png" alt="Microwave Timer" width="200"/></a> |
| **Fitbit's Sleep Tracking**                           | Originally for sleep monitoring, it could serve as a "Spiritual Reflection Tracker," where users reflect on their day and log spiritual activities before bed. | <a href="./assignment_2_docs/fitbit.jpg"><img src="./assignment_2_docs/fitbit.jpg" alt="Fitbit Sleep Tracker" width="200" height="200"/></a> |
| **Google Translate Interface**                         | Caption: Google Translate offers real-time translation, making communication across languages seamless. Integrate a similar translation tool within OrthoNet to enable users from different linguistic backgrounds to participate in discussions, read posts, and engage with content in their preferred language. | <a href="./assignment_2_docs/Translate.jpg"><img src="./assignment_2_docs/Translate.jpg" alt="Google tranlate screenshot" width="200" /></a> |
| **Duolingo's Streak Feature**                         | Implement a prayer or Bible QA streak to motivate daily engagement, with users unlocking inspirational quotes or new prayer new challenging QA stage options as rewards for consistency. | <a href="./assignment_2_docs/duolingo.jpg"><img src="./assignment_2_docs/duolingo.jpg" alt="Duolingo Streak Tracker" width="200"/></a> |
| **Waze's Reporting Icons**                         | Waze uses icons to enable users to report and share information quickly. OrthoNet can Implement an icon-based reporting system for users to quickly indicate prayer needs, event updates, or community alerts etc... making it easier for the community to stay informed and connected. | <a href="./assignment_2_docs/Waze.jpg"><img src="./assignment_2_docs/Waze.jpg" alt="Waze reporting buttons" width="200" /></a> |
| **Precise Location Tagging with What3Words** | "What3Words" is used to provide precise locations. In the OrthoNet application, religious event organizers can host events at a specific grid location on specific dates and times and display them on the map. This allows users to find the exact event locations easily, even in large venues or outdoor spaces. People who set up in-person meetings can also utilize this feature to meet at a certain location. Users can share these three-word addresses to help others navigate directly to specific spots. | <a href="./assignment_2_docs/3Words.jpg"><img src="./assignment_2_docs/3Words.jpg" alt="What3Words Location Tagging" width="200" /></a> |
| **Zillow's Virtual Tours**                         | Originally for real estate, to showcase individual property.  This feature could be used to offer virtual tours of churches, monasteries, or religious sites, giving users an immersive experience. Application: Virtual exploration of sacred spaces. | <a href="./assignment_2_docs/zillow.jpg"><img src="./assignment_2_docs/zillow.jpg" alt="zillow virtual tour" width="200" /></a> |
...
- Chat-GPT to generate the image that is used as a logo
