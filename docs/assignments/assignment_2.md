...
|-------------------------------------------------------|--------------------------------------------------------|-------| -->
- **Microwave Timer**
Used to count down in microwaves. In OrhoNet, it can be utilized in reverse to count up, indicating how long the user has been active in the app in real time. <a href="./assignment_2_docs/microwave.png"><img src="./assignment_2_docs/microwave.png" alt="Microwave Timer" width="400 " height ="400"/></a>
- **Fitbit's Sleep Tracking**
Originally for sleep monitoring, it could serve as a "Spiritual Reflection Tracker," where users reflect on their day and log spiritual activities before bed. <a href="./assignment_2_docs/fitbit.jpg"><img src="./assignment_2_docs/fitbit.jpg" alt="Fitbit Sleep Tracker" width="400 " height ="400"/></a>
